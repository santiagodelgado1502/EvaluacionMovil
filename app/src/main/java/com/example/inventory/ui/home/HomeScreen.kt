...
private fun InventoryItem(
    ...
    Row(modifier = modifier
        ...
        Text(text = item.pasajeros.toString(), modifier = Modifier.weight(1.0f))
        Text(text = item.escalas.toString(), modifier = Modifier.weight(1.0f))
    }
}
...
private val headerList = listOf(
    InventoryHeader(headerStringId = R.string.vuelo , weight = 1.0f),
    InventoryHeader(headerStringId = R.string.precio, weight = 1.0f),
    InventoryHeader(headerStringId = R.string.pasajeros, weight = 1.0f),
    InventoryHeader(headerStringId = R.string.escalas, weight = 1.0f)
)
...
fun HomeScreenRoutePreview() {
    InventoryTheme {
        HomeBody(
            listOf(
                Vuelo(1, "Game", 100.0, 20.0, 2.0),
                Vuelo(2, "Pen", 200.0, 30.0, 1.0),
                Vuelo(3, "TV", 300.0, 50.0, 1.0)
            ),
            onItemClick = {}
        )
    }
